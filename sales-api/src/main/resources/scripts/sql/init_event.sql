INSERT INTO events (event_id, description, event_category, event_date, country, city, street, no, postal_code, name,
                    places_number)
VALUES (1, 'test-description', 'CONCERT', NOW() + INTERVAL '7 days', 'Poland', 'Poznan', 'Stanisława Wyspiańskiego', '33',
        '60-751', 'test-name1', 3);
...
INSERT INTO events (event_id, description, event_category, event_date, country, city, street, no, postal_code, name,
                    places_number)
VALUES (2, 'test-description', 'CONCERT', NOW() + INTERVAL '15 days', 'Poland', 'Poznan',
...
INSERT INTO events (event_id, description, event_category, event_date, country, city, street, no, postal_code, name,
                    places_number)
VALUES (3, 'test-description', 'CONCERT', NOW() + INTERVAL '25 days', 'Poland', 'Poznan', 'Stanisława Wyspiańskiego', '33',
        '60-751', 'test-name3', 1);
